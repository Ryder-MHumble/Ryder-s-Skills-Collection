---
name: aihot
description: AI HOT (aihot.virxact.com) 中文 AI 综合资讯查询 Skill。Use when the user asks for a general AI daily report, broad AI news, AI HOT精选, AI行业动态, AI技巧与观点, or mixed-category AI intelligence. For focused model releases use aihot-ai-models; for focused product launches use aihot-ai-products; for focused papers/research use aihot-ai-papers. Always query the public API instead of answering current AI news from memory.
---
...
- 用户明确问"模型发布/更新"、"大模型发布"、"LLM 更新"、某个模型/模型公司最近发布：优先使用 `aihot-ai-models`。
- 用户明确问"产品发布/更新"、"AI 产品"、"AI 工具更新"、某个产品最近发布：优先使用 `aihot-ai-products`。
- 用户明确问"论文研究"、"AI 论文"、"研究进展"、某个研究主题最近论文：优先使用 `aihot-ai-papers`。
- 本 `aihot` 保留给综合日报、混合精选、行业动态、技巧与观点，以及用户没有指定具体维度的宽泛 AI 资讯问题。
