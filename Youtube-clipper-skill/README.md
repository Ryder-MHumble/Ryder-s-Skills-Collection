...
> AI-powered YouTube video clipper for Codex. Download videos, generate semantic chapters, clip segments, translate subtitles to bilingual format, and burn subtitles into videos.
...
- Copy files to `~/\.codex/skills/youtube-clipper/`
...
Simply tell codex to clip a YouTube video:
...
3. **AI Chapter Analysis** - codex analyzes subtitles to generate semantic chapters (2-5 min each)
...
Unlike mechanical time-based splitting, this skill uses codex's AI to:
...
- **[Codex](https://codex.ai/codex-code)** - The AI-powered CLI tool
