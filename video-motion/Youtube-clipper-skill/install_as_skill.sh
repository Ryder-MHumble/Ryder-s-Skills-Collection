...
##############################################################################
# YouTube Clipper - Codex Skill 安装脚本
#
# 功能：
# 1. 自动创建 Skill 目录
# 2. 复制所有必要文件
...
# 主函数
main() {
    print_header "YouTube Clipper - Codex Skill 安装"

    # 1. 确定 Skill 目录
    SKILL_DIR="$HOME/\.codex/skills/youtube-clipper"
    ...
    print_success "YouTube Clipper 已成功安装为 Codex Skill"
    echo ""
