...
> Codex 的 AI 智能视频剪辑工具。下载视频、生成语义章节、剪辑片段、翻译双语字幕并烧录字幕到视频。
...
安装脚本会：
- 复制文件到 `~/\.codex/skills/youtube-clipper/`
...
3. **AI 章节分析** - codex 分析字幕生成语义章节（每个 2-5 分钟）
...
与机械按时间切分不同，本 skill 使用 codex AI 来：
- 理解内容语义
- 识别自然的主题转换点
- 生成有意义的章节标题和摘要
- 确保完整覆盖，无遗漏
...
- **[Codex](https://codex.ai/codex-code)** - AI 驱动的 CLI 工具
